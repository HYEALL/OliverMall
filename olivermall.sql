...
insert into item values (01, '식물나라 수분 선크림', 10000, 9500, 1000, 500, 4);
insert into item values (02, '닥터지 수분 수딩 크림', 11000, 9000, 1000, 2000, 1);
insert into item values (03, '라네즈 네오 쿠션', 30000, 20000, 1000, 10000, 3);
insert into item values (04, '클리오 펜슬 아이라이너', 11000, 7000, 1000, 3000, 2);
insert into item values (05, '클리오 킬래쉬 마스카라', 18000, 12000, 1000, 6000, 2);
insert into item values (06, '클리오 킬브로우 아이브로우', 20000, 17000, 1000, 3000, 2);
INSERT INTO item VALUES (07,'필리밀리 파워 커링 뷰러', 9500, 8100, 1400, 14, 2);
INSERT INTO item VALUES (08,'에뛰드 톤업 수정 선크림', 25000, 19900, 5100, 20, 4);
INSERT INTO item VALUES(09,'딘토 블러글로이 립 틴트', 20000, 12600, 7400, 37, 2);
...
INSERT INTO orders VALUES ('Y230998','2024-01-09', '주문완료', 01); 
INSERT INTO orders VALUES ('Y567889', '2024-02-22', '주문완료',03); 
INSERT INTO orders VALUES ('Y267889', '2024-04-22', '주문완료',06); 
INSERT INTO orders VALUES ('Z987547', '2024-05-06', '배송중',04);
INSERT INTO orders VALUES ('Q678904', '2024-05-05', '배송중',05);
